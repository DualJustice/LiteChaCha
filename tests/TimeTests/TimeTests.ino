...
// POLY1305 TEST:
	...
	uint32_t key2[8] = {0x7bac2b25, 0x2db447af, 0x09b67a55, 0xa4e95584, 0x0ae1d673, 0x1075d9eb, 0x2a937578, 0x3ed553ff};
	unsigned long long messageLength2 = 160;
	char message2[messageLength2] = {};

	duration = 0;

	for(unsigned short i = 0; i < 5; i += 1) {
		timeStamp = micros();
		mac.createTag(tag, key2, message2, messageLength2);
		duration += (micros() - timeStamp);
	}
	...
	uint32_t key3[8] = {0x85d6be78, 0x57556d33, 0x7f4452fe, 0x42d506a8, 0x0103808a, 0xfb0db2fd, 0x4abff6af, 0x4149f51b};
	unsigned long long messageLength3 = 33;
	char message3[messageLength3] = {"Cryptographic Forum Research Grou"};

	duration = 0;

	for(unsigned short i = 0; i < 5; i += 1) {
		timeStamp = micros();
		mac.createTag(tag, key3, message3, messageLength3);
		duration += (micros() - timeStamp);
	}

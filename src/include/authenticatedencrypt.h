...
inline void CipherManagement::initialize(const char* sharedPrivateKey, const char* userFixedNonce, const char* peerFixedNonce) {
...
inline void CipherManagement::encryptAndTagMessage(unsigned long long& messageCountOut, char* tagOut, char* message, const unsigned long long messageBytes) {
	if(messageBytes > 0) {
...
inline bool CipherManagement::messageAuthentic(const char* message, const unsigned long long messageBytes, const unsigned long long messageCount, const char* tag) {
	if(messageBytes > 0) {
...
inline void CipherManagement::decryptAuthenticatedMessage(char* message, const unsigned long long messageBytes, const unsigned long long messageCount) {
	if(messageBytes > 0) {

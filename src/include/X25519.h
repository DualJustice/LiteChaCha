...
private:
	...
	unsigned char* decodeBytesLittleEndian(unsigned char*);
	unsigned char* clampAndDecodeScalar(unsigned char*);
	void toUInt(uint32_t*, const unsigned char*);
	unsigned char* maskAndDecodeXCoord(unsigned char*);
